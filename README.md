...
Link to see demo of the Threads application can be seen here (requires registration through Clerk to sign-in and view): https://threads-app-gamma-three.vercel.app/ 
